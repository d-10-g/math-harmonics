...
function lightingRigSettings(preset: WebGPULightingPreset) {
  switch (preset) {
    case 'aurora':
      return {
        background: 0x06111f,
        ...
        rim: 0xd946ef,
        fill: 0x38bdf8,
        keyPosition: [-3.5, 8.0, 7.0] as [number, number, number],
        rimPosition: [5.5, 2.8, 8.0] as [number, number, number],
        fillPosition: [-6.0, -2.5, 4.5] as [number, number, number],
        ambientScale: 0.3,
        hemiScale: 0.62,
        keyScale: 1.55,
        rimScale: 18.0,
    ...
    case 'gallery':
      return {
        ...
        rim: 0xf59e0b,
        fill: 0xa78bfa,
        keyPosition: [0.0, 9.0, 6.0] as [number, number, number],
        rimPosition: [-7.0, 3.5, 6.0] as [number, number, number],
        fillPosition: [6.0, -2.0, 5.0] as [number, number, number],
        ambientScale: 0.46,
        hemiScale: 0.5,
        keyScale: 2.5,
        rimScale: 8.0,
    ...
    case 'eclipse':
      return {
        ...
        rim: 0xff3d81,
        fill: 0x22d3ee,
        keyPosition: [-7.0, 1.2, 9.0] as [number, number, number],
        rimPosition: [7.5, 0.2, 8.5] as [number, number, number],
        fillPosition: [0.0, -5.0, 6.0] as [number, number, number],
        ambientScale: 0.18,
        hemiScale: 0.28,
        keyScale: 1.1,
        rimScale: 26.0,
    ...
    case 'caustic':
      return {
        ...
        rim: 0xf0fdfa,
        fill: 0x2dd4bf,
        keyPosition: [3.0, 7.5, 8.5] as [number, number, number],
        rimPosition: [-4.0, 4.0, 8.0] as [number, number, number],
        fillPosition: [6.0, -3.4, 5.5] as [number, number, number],
        ambientScale: 0.34,
        hemiScale: 0.78,
        keyScale: 1.9,
        rimScale: 16.0,
    ...
    case 'noir':
      return {
        ...
        rim: 0xef4444,
        fill: 0x60a5fa,
        keyPosition: [-4.5, 7.5, 7.5] as [number, number, number],
        rimPosition: [6.5, 1.5, 6.8] as [number, number, number],
        fillPosition: [-6.0, -3.5, 4.5] as [number, number, number],
        ambientScale: 0.12,
        hemiScale: 0.18,
        keyScale: 2.0,
        rimScale: 22.0,
    ...
    case 'sunset':
      return {
        ...
        rim: 0xfb7185,
        fill: 0x818cf8,
        keyPosition: [7.5, 2.8, 8.0] as [number, number, number],
        rimPosition: [-6.5, 4.2, 7.0] as [number, number, number],
        fillPosition: [-2.0, -4.0, 5.2] as [number, number, number],
        ambientScale: 0.34,
        hemiScale: 0.48,
        keyScale: 2.6,
        rimScale: 14.0,
    ...
    case 'laboratory':
      return {
        ...
        rim: 0x22d3ee,
        fill: 0xa7f3d0,
        keyPosition: [0.0, 8.8, 5.2] as [number, number, number],
        rimPosition: [-5.5, 4.8, 6.0] as [number, number, number],
        fillPosition: [5.5, -2.2, 4.8] as [number, number, number],
        ambientScale: 0.52,
        hemiScale: 0.7,
        keyScale: 2.2,
        rimScale: 10.5,
    ...
    case 'underlight':
      return {
        ...
        rim: 0xf0abfc,
        fill: 0x34d399,
        keyPosition: [1.0, -6.5, 7.0] as [number, number, number],
        rimPosition: [-6.8, 2.2, 7.5] as [number, number, number],
        fillPosition: [6.6, -4.8, 5.0] as [number, number, number],
        ambientScale: 0.16,
        hemiScale: 0.24,
        keyScale: 2.9,
        rimScale: 18.5,
    ...
    case 'prism':
      return {
        ...
        rim: 0x22d3ee,
        fill: 0xfacc15,
        keyPosition: [5.5, 5.4, 8.2] as [number, number, number],
        rimPosition: [-6.0, 3.8, 8.0] as [number, number, number],
        fillPosition: [0.4, -5.8, 6.2] as [number, number, number],
        ambientScale: 0.28,
        hemiScale: 0.42,
        keyScale: 2.15,
        rimScale: 16.5,
    ...
    default:
      return {
        ...
        rim: 0x22d3ee,
        fill: 0xff8bd5,
        keyPosition: [5.0, 7.0, 10.0] as [number, number, number],
        rimPosition: [-6.0, 2.5, 8.0] as [number, number, number],
        fillPosition: [6.0, -3.0, 7.0] as [number, number, number],
        ambientScale: 0.22,
        hemiScale: 0.32,
        keyScale: 2.3,
        rimScale: 16.0,
