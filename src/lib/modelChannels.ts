...
export type BackgroundChoice='cosmos'|'midnight'|'charcoal'|'slate'|'ivory'|'white'|'mirror'|'hdri';
export const BACKGROUNDS:Record<Exclude<BackgroundChoice,'hdri'>,string>={cosmos:'#090c1c',midnight:'#101a20',charcoal:'#24262b',slate:'#627684',ivory:'#ece8de',white:'#ffffff',mirror:'#05070c'};
